...
export const ca: Dictionary = {
  ...
  globe: {
    ...
    west: "oest",
    math: {
      whereTitle: "Com s'ha situat aquest punt",
      whoTitle: "Qui hauria pogut ser",
      cellOf: "cel·la de 0,5° · {country}",
      people: "persones",
      perThousand: "per cada 1.000 a l'any",
      deathsPerYear: "morts a l'any",
      seasonalIn: "estacional · {month}",
      conflict: "conflicte armat",
      share: "1 de cada {odds} dels {total} del món a l'any",
      sex: "Sexe",
      age: "Edat",
      cause: "Causa",
      drawn: "sortida",
      tierRegional: "piràmide regional",
      tierDerived: "població local × taxes nacionals",
      tierNational: "piràmide nacional",
      causeOptions: "{count} causes en aquest grup",
      causeFallback: "No hi ha taula de causes mesurada per a aquest grup.",
    },
  },
