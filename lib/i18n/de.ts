...
export const de: Dictionary = {
  ...
  globe: {
    ...
    west: "West",
    math: {
      whereTitle: "Wie dieser Punkt platziert wurde",
      whoTitle: "Wer es hätte sein können",
      cellOf: "0,5°-Zelle · {country}",
      people: "Menschen",
      perThousand: "pro 1.000 im Jahr",
      deathsPerYear: "Todesfälle im Jahr",
      seasonalIn: "saisonal · {month}",
      conflict: "bewaffneter Konflikt",
      share: "1 von {odds} der weltweit {total} im Jahr",
      sex: "Geschlecht",
      age: "Alter",
      cause: "Todesursache",
      drawn: "gezogen",
      tierRegional: "regionale Pyramide",
      tierDerived: "lokale Bevölkerung × nationale Raten",
      tierNational: "nationale Pyramide",
      causeOptions: "{count} Ursachen in dieser Gruppe",
      causeFallback: "Keine gemessene Ursachentabelle für diese Gruppe.",
    },
  },
