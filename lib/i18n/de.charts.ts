...
export const chartsDe: ChartsDictionary = {
  ...
  amplitudeMap: {
    ...
    sourceNone: "keine Saisonkurve erreicht diese Zelle",
    sourceRegionMeasured: "eine Kurve für diese ganze Region, dort gemessen",
    sourceRegionClimate: "eine Kurve für diese ganze Region, aus ihrem Klima modelliert",
    sourceRegionImputed: "eine Kurve für diese ganze Region, geschätzt aus {donors}",
    sourceWholeCountry: "eine Kurve für das ganze Land, {basis}",
