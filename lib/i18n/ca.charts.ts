...
export const chartsCa: ChartsDictionary = {
  ...
  amplitudeMap: {
    ...
    sourceNone: "cap corba estacional arriba a aquesta cel·la",
    sourceRegionMeasured: "una corba per a tota aquesta regió, mesurada allà",
    sourceRegionClimate: "una corba per a tota aquesta regió, modelada a partir del seu clima",
    sourceRegionImputed: "una corba per a tota aquesta regió, imputada a partir de {donors}",
    sourceWholeCountry: "una corba per a tot el país, {basis}",
