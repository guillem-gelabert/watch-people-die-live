...
// 44 bars is what fits across a phone at a legible width, and it is long enough that the
// Poisson strip shows several clusters and several gaps in one screen.
const BARS = 44;
